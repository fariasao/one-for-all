...
VALUES
  ...
  ('Fog');
    ...
    plano_preco DECIMAL(7,2) NOT NULL
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.planos (plano, plano_preco)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitário', 5.99),
...
CREATE TABLE SpotifyClone.usuarios(
    ...
    reproduzida_data DATE NOT NULL,
    FOREIGN KEY (plano_id) REFERENCES SpotifyClone.planos(plano_id)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.usuarios (usuario, idade, plano_id,  reproduzida_data)
VALUES
 ...
 CREATE TABLE SpotifyClone.albuns (
    ...
    album_estreia YEAR NOT NULL,
    artista_id INT NOT NULL,
    FOREIGN KEY (artista_id)
        REFERENCES SpotifyClone.artistas (artista_id)
)  ENGINE=InnoDB;

INSERT INTO SpotifyClone.albuns (album, artista_id, album_estreia)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
  ...
  CREATE TABLE SpotifyClone.musicas(
    ...
    musica_segundos INT NOT NULL,
    album_id INT NOT NULL,
    FOREIGN KEY (album_id) REFERENCES SpotifyClone.albuns(album_id)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.musicas (album_id, musica,  musica_segundos)
VALUES
  (1, "Soul For Us", 200),
...
VALUES
  ...
  CREATE TABLE SpotifyClone.reproduzida(
    reproduzida_data DATETIME NOT NULL,
    usuario_id INT NOT NULL,
...
INSERT INTO SpotifyClone.reproduzida (usuario_id, musica_id, reproduzida_data)
VALUES
